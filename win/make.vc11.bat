...
copy ..\build.vc11\gen_mpir_h.bat .
copy ..\build.vc11\out_copy_rename.bat .
copy ..\build.vc11\gen_config_h.bat .
copy ..\build.vc11\cfg.h .
...
if %LIBTYPE% == lib (
	lib /nologo scanf\*.obj printf\*.obj mpz\*.obj mpq\*.obj mpf\*.obj mpn\*.obj *.obj /out:mpir_a.%LIBTYPE%
	if errorlevel 1 goto :err
...
if errorlevel 1 goto :err
cl %OPT% /c ..\..\build.vc11\getopt.c /I..\..
if errorlevel 1 goto :err
...
copy ..\build.vc11\unistd.h .
copy ..\build.vc11\getopt.h .
copy ..\build.vc11\win_timing.h .
copy ..\build.vc11\getrusage.h .
copy ..\build.vc11\gettimeofday.h .

cd speed
cl %OPT% /c ..\..\tests\misc.c /I..\..
cl %OPT% /c ..\..\tests\memory.c /I..\..
cl %OPT% /c ..\..\tests\refmpn.c /I..\..
cl %OPT% /c ..\..\build.vc11\win_timing.c
cl %OPT% /c ..\..\build.vc11\getopt.c /I..\..
